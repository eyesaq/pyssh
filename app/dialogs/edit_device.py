...
class EditDeviceDialog(BaseDeviceInput):
    def __init__(self, parent, app, update_data: Callable):
        ...
        self.old_state = self._app.database.get_device_info_by_ip(self._parent.ip_address)
    ...
    def edit_device(self, ip_address, device_name, username, password):
        self._app.database.update_device_by_ip(self.old_state[0], ip_address, device_name, username, password)
